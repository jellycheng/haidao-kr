...
CREATE TABLE `hd_adv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='广告管理';
...
CREATE TABLE `hd_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='商品评价表';
...
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='物流配送表';
...
CREATE TABLE `hd_delivery_district` (
  ...
  `sort` int(8) unsigned NOT NULL DEFAULT '100' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='物流地区设置';
...
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='商品咨询表';
...
CREATE TABLE `hd_member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COMMENT='用户表';
...
CREATE TABLE `hd_member_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='用户收货地址';
...
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='会员充值记录表';
...
CREATE TABLE `hd_member_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='会员等级组';
...
CREATE TABLE `hd_member_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=271 DEFAULT CHARSET=utf8 COMMENT='财务变动记录表';
...
CREATE TABLE `hd_member_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='站内信';


-- ----------------------------
-- Table structure for hd_module
-- ----------------------------
...
CREATE TABLE `hd_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=211 DEFAULT CHARSET=utf8 COMMENT='订单主表';
...
CREATE TABLE `hd_order_delivery` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='订单物流表';
...
CREATE TABLE `hd_order_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_sn` (`order_sn`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=418 DEFAULT CHARSET=utf8 COMMENT='订单日志表';
...
CREATE TABLE `hd_order_parcel` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_sn` (`order_sn`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='发货单管理';
...
CREATE TABLE `hd_order_parcel_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_sn` (`order_sn`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='订单发货单日志';
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='订单退款';
...
CREATE TABLE `hd_order_refund_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_sn` (`order_sn`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='订单退款日志';
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='订单退货';
...
CREATE TABLE `hd_order_return_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_sn` (`order_sn`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='订单退货日志';
...
CREATE TABLE `hd_order_server` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='订单售后索引表';
...
CREATE TABLE `hd_order_sku` (
  ...
  UNIQUE KEY `id` (`id`) USING BTREE,
  KEY `order_sn` (`order_sn`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=195 DEFAULT CHARSET=utf8 COMMENT='订单商品表';
...
CREATE TABLE `hd_order_sub` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=201 DEFAULT CHARSET=utf8 COMMENT='子订单表';
...
CREATE TABLE `hd_order_track` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_sn` (`order_sn`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=387 DEFAULT CHARSET=utf8 COMMENT='订单跟踪';
...
-- ----------------------------
-- Table structure for hd_payment_copy
-- ----------------------------
DROP TABLE IF EXISTS `hd_payment_copy`;
CREATE TABLE `hd_payment_copy` (
  `pay_code` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE `hd_promotion_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='商品促销表';
...
CREATE TABLE `hd_promotion_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='订单促销';
...
CREATE TABLE `hd_queue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=184 DEFAULT CHARSET=utf8 COMMENT='队列表';
...
-- ----------------------------
-- Records of hd_setting
-- ----------------------------
INSERT INTO `hd_setting` VALUES ('site_name', '海盗云商演示站');
INSERT INTO `hd_setting` VALUES ('com_name', '迪米盒子科技有限公司');
INSERT INTO `hd_setting` VALUES ('site_url', 'http://www.haidao.la');
INSERT INTO `hd_setting` VALUES ('icp', '滇ICP备13005806号');
INSERT INTO `hd_setting` VALUES ('site_isclosed', '1');
INSERT INTO `hd_setting` VALUES ('site_logo', '');
INSERT INTO `hd_setting` VALUES ('site_closedreason', '商城维护中');
INSERT INTO `hd_setting` VALUES ('timeoffset', '8');
INSERT INTO `hd_setting` VALUES ('points_rate', '1:1');
INSERT INTO `hd_setting` VALUES ('exp_rate', '3');
INSERT INTO `hd_setting` VALUES ('cart_jump', '2');
INSERT INTO `hd_setting` VALUES ('stock_change', '1');
INSERT INTO `hd_setting` VALUES ('balance_pay', '1');
INSERT INTO `hd_setting` VALUES ('balance_deposit', 'a:1:{i:0;s:6:\"alipay\";}');
INSERT INTO `hd_setting` VALUES ('invoice_enabled', '1');
INSERT INTO `hd_setting` VALUES ('invoice_tax', '5');
INSERT INTO `hd_setting` VALUES ('invoice_vat_enabled', '1');
INSERT INTO `hd_setting` VALUES ('seos', 'a:4:{s:16:\"header_title_add\";s:48:\"全球领先的企业级电子商务网店系统\";s:15:\"header_keywords\";s:123:\"海盗,海盗云商,海盗电商,云商,迪米盒子,海盗系统,网店系统,独立网店,商城系统,电子商务软件\";s:18:\"header_description\";s:189:\"海盗云商开源网店系统演示站，国内专业电子商务系统方案解决服务商，最灵活的企业级网店系统，为中小企业级站长提供电商一站式解决方案\";s:12:\"header_other\";s:0:\"\";}');
INSERT INTO `hd_setting` VALUES ('formhash', 'MuD1lb');
INSERT INTO `hd_setting` VALUES ('page', '1');
INSERT INTO `hd_setting` VALUES ('sender_name', '海盗测试站');
INSERT INTO `hd_setting` VALUES ('sender_mobile', '');
INSERT INTO `hd_setting` VALUES ('sender_address', '');
INSERT INTO `hd_setting` VALUES ('site_statice', '');
INSERT INTO `hd_setting` VALUES ('invoice_content', 'a:3:{i:0;s:12:\"办公用品\";i:1;s:12:\"生活用品\";i:2;s:12:\"商品清单\";}');
INSERT INTO `hd_setting` VALUES ('reg_allow', '1');
INSERT INTO `hd_setting` VALUES ('reg_closedreason', '系统维护，暂停注册。');
INSERT INTO `hd_setting` VALUES ('reg_user_fields', 'a:0:{}');
INSERT INTO `hd_setting` VALUES ('reg_user_censor', '管理员*\r\n*海盗*');
INSERT INTO `hd_setting` VALUES ('pays', 'a:2:{i:0;s:6:\"alipay\";i:1;s:9:\"wechat_qr\";}');
INSERT INTO `hd_setting` VALUES ('pay_type', '2');
INSERT INTO `hd_setting` VALUES ('reg_pass_lenght', '6');
INSERT INTO `hd_setting` VALUES ('reg_pass_complex', 'a:0:{}');
INSERT INTO `hd_setting` VALUES ('reg_agreement', '');
INSERT INTO `hd_setting` VALUES ('hot_seach', '手机\r\n苹果7s\r\n三星');
INSERT INTO `hd_setting` VALUES ('seller_address', '');
INSERT INTO `hd_setting` VALUES ('seller_name', '');
INSERT INTO `hd_setting` VALUES ('seller_mobile', '');
INSERT INTO `hd_setting` VALUES ('seller_zipcode', '');
...
CREATE TABLE `hd_spec` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='商品规格';
...
CREATE TABLE `hd_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='商品模型';
